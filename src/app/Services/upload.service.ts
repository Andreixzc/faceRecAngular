...
export class UploadService {
  ...
  postImages(formData: FormData) {
    ...
    let jwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJGYWNlUmVjIiwic3ViIjoiYmJlMGJhNTAtYTNlOC00ZjUzLWIxMGYtMjA0NTkzNDdjMGY1IiwiZXhwIjoxNzA3MTEyMTU5fQ.rwMjVJ6JWmro4adqitJfm1BlQVDC14SF72Af995HqGg";
